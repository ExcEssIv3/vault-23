# Vault 23 — Open Questions / Next to Flesh Out

1. Ending gating: what specific skill checks, evidence thresholds, or dialogue conditions unlock each ending sub-variant (A0/A1/A2, B1/B2/B3, C, D1/D2). See [endings.md](endings.md).
...
3. B1 still needs firmer internal logic for why the family specifically turns on the new Overseer's legitimacy and attempts resealing, and how that plays out mechanically. See [epilogues.md](epilogues.md).
